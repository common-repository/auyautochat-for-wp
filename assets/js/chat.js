...
! function(t) {
                ...
                this.callAPI = function(e, n, r, i, a) {
                    ...
                    var s = new FormData,
                        c = {
                            driver: "web",
                            userId: t.userId,
							c_id: parent.autochatWidget.client,
                            message: e,
                            attachment: r,
                            interactive: n ? "1" : "0"
                        };
                    ...
                    }), o.a.post(parent.autochatWidget.chatServer, s).then(function(t) {
    ...
    function r() {
        ...
        t.id = "autoChatRoot", document.getElementsByTagName("body")[0].appendChild(t), Object(a.c)(Object(a.b)(s.a, {
            userId: o(),
            conf: c
        }), t)
    }
    ...
    e.a = function(t) {
        function e(n) {
            ...
            }, r.autochat = i.a, r.autochat.setUserId(r.props.userId), r.autochat.setChatServer(r.props.conf.chatServer), r.state.messages = [], r.state.replyType = s.Text, r
        }
        return a(e, t), e.prototype.componentDidMount = function() {
            ...
            this.autochat.callAPI(r.text, !1, null, function(t) {
    ...
    e.a = function(t) {
        ...
        return i(e, t), e.prototype.render = function(t) {
            var e = "height:" + (t.conf.wrapperHeight - 80) + "px;",
                n = 0;
    ...
    e.a = function(t) {
        function e() {
            ...
            return e.scrollToBottom = function() {
                ...
                var e = document.getElementsByClassName("chat");
				...
				var auy_chat = document.getElementsByClassName("chat");
				auy_setCookie("auy_open", "1", 20*60*1000);
				
				if(Array.isArray(r.additionalParameters) && r.additionalParameters[0] == "FIN"){
					
					var finish_msj = r.additionalParameters[1];
					auy_finalMessage(auy_chat, finish_msj);
				}else{
					var auy_loading = auy_readCookie("auy_loading");
					
					if(auy_loading == "false" || auy_loading == null){
						auy_cookies(r);
					}
...
function auy_finalMessage(auy_chat, finish_msj){
	auy_setCookie("auy_conv", "", -1000);
	auy_setCookie("auy_loading", "", -1000);
	auy_setCookie("auy_conv_id", "", -1000);
	
	//Placeholder and disable
	document.getElementById("userText").disabled = true;
	document.getElementById("userText").removeAttribute("placeholder");
	
	setTimeout(
		function() {
			
			var auy_message = document.createElement("li");
			auy_message.setAttribute("class", "chat_final");
			auy_message.textContent = finish_msj;
			auy_chat[0].appendChild (auy_message);
			
			//Scroll down
			var t = document.getElementById("messageArea");
			t.scrollTop = t.scrollHeight
			auy_chat[0].scrollTop = auy_chat[0].scrollHeight
...
function auy_cookies(r){
	var data = auy_readCookie("auy_conv");
	...
	var convArr = [r.from, r.text];
	cookieData.push(convArr);
	var auy_conv = JSON.stringify(cookieData);
	
	auy_setCookie("auy_conv", auy_conv, 30*60*1000);
	
	if(r.additionalParameters != null && r.additionalParameters != "FIN" && !Array.isArray(r.additionalParameters)){
		var conv_id = auy_readCookie("auy_conv_id");
		if(conv_id == null){
			auy_setCookie("auy_conv_id", r.additionalParameters, 30*60*1000);
		}
	}
...
function auy_readCookie(name) {
    var nameEQ = name + "=";
    var ca = document.cookie.split(';');
    for(var i=2;i < ca.length;i++) {
        var c = ca[i];
...
function auy_setCookie(cname, cvalue, ctime) {
  var d = new Date();
